...
class ScalarFunctionsTest extends GlutenStreamingTestBase {
    ...
    public void before() throws Exception {
        super.before();
        List<Row> rows =
                Arrays.asList(Row.of(1, 1L, "1", 100, 10L), Row.of(2, 2L, "2", 3, 11L), Row.of(3, 3L, "3", 5, 12L));
    ...
    @Test
    void testAdd() {
        String query1 = "select a + b as x from t1";
        runAndCheck(query1, Arrays.asList("+I[2]", "+I[4]", "+I[6]"));

        String query2 = "select a + 1 as x from t1";
